 ...
 * @author ezisouli
 */
public class ManagerOption1 extends javax.swing.JFrame {

	/**
	 * Creates new form ManagerOption1
	 */
	public ManagerOption1() {
		initComponents();
	}
	...
	private void initComponents() {
		...
		jLabel1.setText("Συνολικά Κέρδη Επιχείρησης");
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout
						...
						.addGroup(jPanel1Layout.createSequentialGroup().addGap(106, 106, 106).addComponent(jTextField2,
		...
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
						jPanel1Layout.createSequentialGroup().addGap(19, 19, 19)
								.addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 52,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(43, 43, 43).addComponent(jTextField2, javax.swing.GroupLayout.PREFERRED_SIZE,
	...
	private void jTextField2ActionPerformed(java.awt.event.ActionEvent evt) {
		jTextField2.setText(String.valueOf(ManagerMenu.totalProfit));
		setVisible(false);
	}
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(ManagerOption1.class.getName()).log(java.util.logging.Level.SEVERE, null,
					ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new ManagerOption1().setVisible(true);
			}
		});
	}
