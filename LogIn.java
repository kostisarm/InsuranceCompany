...
public class LogIn extends javax.swing.JFrame {
	...
	private void initComponents() {
						...
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
								...
								.addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout
										...
										.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
												jPanel1Layout.createSequentialGroup().addGap(53, 53, 53).addComponent(
														Cancel_Button, javax.swing.GroupLayout.PREFERRED_SIZE, 95,
														javax.swing.GroupLayout.PREFERRED_SIZE)))
		...
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				...
				.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap()
						...
						.addGap(90, 90, 90)
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
								.addComponent(jLabel7).addComponent(jPasswordField1,
						...
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(Cancel_Button, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(Login_Button, javax.swing.GroupLayout.PREFERRED_SIZE, 40,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
				.addGroup(jPanel1Layout.createSequentialGroup().addComponent(XButton).addGap(0, 0, Short.MAX_VALUE)));
	...
	private void Login_ButtonActionPerformed(java.awt.event.ActionEvent evt) {
		...
		try {
			...
			if (rs.next()) {
				setVisible(false);
				if (jTextField1.getText().contains("s") && ManagerSalesmanChoice.a.equals("s")) {
					SalesmanMenu sl = new SalesmanMenu();
					sl.setVisible(true);
					usernameS = jTextField1.getText();

				} else if (jTextField1.getText().contains("m") && ManagerSalesmanChoice.a.equals("m")) {
					...
					if (tries + tries2 < 3) {
						JOptionPane.showMessageDialog(this, "Λάθος Σύνδεση. Προσπαθήστε ξανά.");
						LogIn ln = new LogIn();
						ln.setVisible(true);
					} else {
						JOptionPane.showMessageDialog(this,
								"Τρεις άκυρες προσπάθειες σύνδεσης. Απομακρύνεστε από το σύστημα.");
						tries = 0;
						tries2 = 0;
